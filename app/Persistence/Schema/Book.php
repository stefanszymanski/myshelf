...
class Book extends AbstractSchema
{
    ...
    protected function configure(): void
    {
        $this->registerDataFields([
            ...
            'persons' => DataFieldFactory::struct(
                ...
                fields: [
                    ...
                    'illustrators' => DataFieldFactory::references('person', label: 'Illustrators', sortable: true),
        ...
        $this->registerQueryFields([
            ...
            'persons.editors' => QueryFieldFactory::forDatafield('persons.editors', label: 'Editors'),
        ...
        $this->registerQueryFilters([
            ...
            'persons.translator' => QueryFilterFactory::forReference('persons.translator', 'person', isMultivalue: true),
            'persons.illustrator' => QueryFilterFactory::forReference('persons.illustrator', 'person', isMultivalue: true),
            'persons.editor' => QueryFilterFactory::forReference('persons.editor', 'person', isMultivalue: true),
